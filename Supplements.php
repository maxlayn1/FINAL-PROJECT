...
<body>
    ...
    <div class="suppDefBox w3-bar w3-green">
        <p class="suppDefBoxTitle w3-bar-item">
            Supplements
        </p>
        <p class="textInDefBox w3-bar-item">
            Supplements refer to substances that are consumed in addition to the regular diet. These can encompass a </br>wide range of products, including vitamins, herbal remedies, and other nutritional or health-related items that </br>are not typically part of one's daily food intake.
        </p>
    </div>
